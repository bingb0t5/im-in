...
DROP FUNCTION IF EXISTS public.list_event_gallery_for_view(TEXT, TEXT, TEXT);
...
BEGIN
    SELECT *
    INTO v_event
    FROM public.get_event_for_view(p_slug, p_access_code, p_session_token)
    LIMIT 1;
...
GRANT EXECUTE ON FUNCTION public.list_event_gallery_for_view(TEXT, TEXT, TEXT) TO anon, authenticated;
