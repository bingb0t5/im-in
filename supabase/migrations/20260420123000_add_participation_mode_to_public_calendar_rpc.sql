DROP FUNCTION IF EXISTS public.list_public_calendar_events(TIMESTAMPTZ);
...
CREATE OR REPLACE FUNCTION public.list_public_calendar_events(
    ...
    SELECT
        ...
        COALESCE(e.participation_mode, 'rsvp') AS participation_mode,
        COALESCE(e.interest_visibility, 'count_only') AS interest_visibility,
        COALESCE(e.origin_type, 'host_created') AS origin_type,
        e.source_attribution_label,
        e.trust_badge,
        (
